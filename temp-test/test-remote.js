...
async function testAllRoutes() {
  console.log('--- STARTING COMPREHENSIVE ROUTE TESTS ON REMOTE SERVER ---\n');
  const baseUrl = 'https://smith-ai-ykex.onrender.com';
  ...
  try {
    ...
    if (resumeRes.status !== 200) {
      console.log('Error Body:', resumeData);
    }
    ...
    console.log('--- ALL REMOTE ROUTES TESTED SUCCESSFULLY ✅ ---');

  } catch (err) {
    console.error('Error during remote testing:', err);
  }
}
